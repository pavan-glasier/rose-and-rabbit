        ...
        window.addEventListener('load', function () {
            ...
            jQuery(".woocommerce-save-button").off().click(function () {
                if (jQuery('#woocommerce_shiprocket_woocommerce_shipping_realtime_enabled').is(":checked")) {
                    ...
                    var method_title = jQuery('#woocommerce_shiprocket_woocommerce_shipping_shipping_title').val();
                    if (method_title == '')
                    {
                        alert("Enter method title");
                        return false;
                    }
...
return array(
    ...
    'shipping_title' => array(
        'title' => __('Shipping Method Title', 'shiprocket-woocommerce-shipping-calculator'),
        'type' => 'text',
        'default' => 'Shipping Rate',
        'description' => __("Shipping service name you want to show to your customers at the checkout", 'shiprocket-woocommerce-shipping-calculator'),
        'desc_tip' => true,
    ),
    'fallback_rate' => array(
        'title' => __('Fallback Rates', 'shiprocket-woocommerce-shipping-calculator'),
        'type' => 'text',
        'default' => '40',
    ...
    'shipping_title_flat' => array(
        'title' => __('Flat Rate Method Title', 'shiprocket-woocommerce-shipping-calculator'),
        'type' => 'text',
        'default' => 'Flat Rate',
    ...
    'flat_rate' => array(
        'title' => __('Flat Shipping Rates', 'shiprocket-woocommerce-shipping-calculator'),
        'type' => 'text',
        'default' => '40',
