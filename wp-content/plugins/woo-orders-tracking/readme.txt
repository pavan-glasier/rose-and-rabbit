...
&#9658; Tracking service
 ...
 - **More tracking services supported**: Besides TrackingMore the premium version supports Cainiao, EasyPost and Aftership. The plugin will get the shipping information from these tracking services and transfer it to your customers.

 - **TrackingMore, EasyPost, Aftership**: These options require a valid API to work. Orders Tracking for WooCommerce will automatically get tracking information from these tracking services.

 - **Cainiao**: This tracking service doesn’t need API to work.
