 ...
 *
 * @package wp-menu-navwalker
 *
 * @wordpress-plugin
 * Plugin Name: WP Bootstrap Navwalker
 * Plugin URI:  https://github.com/wp-bootstrap/wp-menu-navwalker
 * Description: A custom WordPress nav walker class to implement the Bootstrap 4 navigation style in a custom theme using the WordPress built in menu manager.
 * Author: Edward McIntyre - @twittem, WP Bootstrap, William Patton - @pattonwebz
 * Version: 4.3.0
 * Author URI: https://github.com/wp-bootstrap
 * GitHub Plugin URI: https://github.com/wp-bootstrap/wp-menu-navwalker
...
if ( ! class_exists( 'WP_Menu_Navwalker' ) ) :
	/**
	 * WP_Menu_Navwalker class.
	 */
	class WP_Menu_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			$item_output .= isset( $args->link_before ) ? $icon_html . $args->link_before . $title . $args->link_after : '';
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="elementor-item" title="' . esc_attr__( 'Add a menu', 'wp-menu-navwalker' ) . '">' . esc_html__( 'Add a menu', 'wp-menu-navwalker' ) . '</a></li>';
			$fallback_output .= '</ul>';
